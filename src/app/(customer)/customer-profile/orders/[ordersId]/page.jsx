      ...
      {isLoading ? (
        ...
        <div>
          ...
          <div className="mb-10">
            ...
            <p className="mb-1">
              {orderDetails?.user?.street}, {orderDetails?.user?.city}
            </p>
            <p className="mb-1">
              {orderDetails?.user?.province}, {orderDetails?.user?.postalCode}
            </p>
            <p className="mb-6">{orderDetails?.user?.country}</p>
                ...
                <tfoot>
                  ...
                  <tr>
                    <td
                      ...
                      colSpan="3"
                    >
                      Tax ({orderDetails?.taxInfo?.taxName}):
                    </td>
                    <td className="px-4 py-2 text-right">
                      $
                      {(
                        (orderDetails?.taxInfo?.taxPercentage / 100) *
                        calculateSubtotal()
                      ).toFixed(2)}
                    </td>
                  </tr>
