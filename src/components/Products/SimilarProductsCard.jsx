...
const SimilarProductsCard = ({ product }) => {
  ...
  return (
    <div className="border rounded-2xl p-4 text-left xs:w-[300px] mx-auto sm:w-[300px] md:w-[300px] lg:w-[300px] xl:w-[300px] h-[500px] sm:h-[520px] md:h-[500px] lg:h-[500px] flex flex-col justify-between">
